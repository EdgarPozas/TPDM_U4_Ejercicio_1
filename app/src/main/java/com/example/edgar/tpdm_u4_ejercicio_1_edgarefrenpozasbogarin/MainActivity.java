package com.example.edgar.tpdm_u4_ejercicio_1_edgarefrenpozasbogarin;
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                if(tot1>tot2&&tot1>tot3){
                    Toast.makeText(MainActivity.this,"El ganador es el jugador 1",Toast.LENGTH_SHORT).show();
                    return;
                }
                if(tot2>tot1&&tot2>tot3){
                    Toast.makeText(MainActivity.this,"El ganador es el jugador 2",Toast.LENGTH_SHORT).show();
                    return;
                }
